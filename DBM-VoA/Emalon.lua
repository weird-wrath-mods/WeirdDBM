...
local timerOvercharge		= mod:NewNextTimer(40, 64218, nil, nil, nil, 5, nil, DBM_COMMON_L.DAMAGE_ICON)--AC: events.Repeat(40s)
...
function mod:OnCombatStart(delay)
	timerOvercharge:Start(47-delay)	-- AC: ScheduleEvent(EVENT_OVERCHARGE, 47s) on aggro
	timerNovaCD:Start(40-delay)	-- AC: ScheduleEvent(EVENT_LIGHTNING_NOVA, 40s) on aggro, same both sizes
